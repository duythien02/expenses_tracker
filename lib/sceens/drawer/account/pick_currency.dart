...
class _PickCurrencyScreenState extends State<PickCurrencyScreen> {
  ...
  void initState() {
    ...
    var index = listCurrency
        .indexWhere((element) => element.code == widget.currency.code);
          ...
          itemBuilder: (context, index) => isSearching
              ? Container(
                  ...
                  child: GestureDetector(
                    onTap: () {
                      if (_searchList.indexWhere((e) => e.picked == true) >=
                          0) {
                        _searchList[
                                _searchList.indexWhere((e) => e.picked == true)]
                            .picked = false;
                      }
              ...
              : Container(
                  ...
                  child: GestureDetector(
                    onTap: () {
                      if (listCurrency.indexWhere((e) => e.picked == true) >=
                          0) {
