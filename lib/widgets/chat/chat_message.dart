...
class Chat extends StatelessWidget {
  ...
  String formatTime(DateTime currentChatMessageTime) {
    if (currentChatMessageTime.day != DateTime.now().day &&
        currentChatMessageTime.month != DateTime.now().month) {
  ...
  Widget dividerTime(DateTime currentChatMessageTime) {
    return Row(children: [
      ...
      Text(
        formatTime(currentChatMessageTime),
  ...
  Widget build(BuildContext context) {
    return StreamBuilder(
      ...
      builder: (ctx, chatSnapshots) {
        ...
        listChatMessages =
            loadedMessages.map((e) => ChatMessage.fromMap(e.data())).toList();
        ...
        return ListView.builder(
            ...
            itemBuilder: (ctx, index) {
              ...
              if (nextChatMessage != null) {
                if (!DateUtils.isSameDay(currentMessageTime, nextMessageTime)) {
                  return Column(
                    children: [
              ...
              if (index - 1 < 0 && currentMessageFrom == FirebaseAPI.user.uid) {
                return Column(
                  children: [
                    ...
                    AnimatedTextKit(
                      animatedTexts: [
                        TypewriterAnimatedText("Gemini đang phản hồi...",
